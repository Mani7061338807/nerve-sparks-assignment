<script>
  ...
  <div class="w-[100vw] min-h-[100vh] bg-[#040517] flex justify-center items-center">
    ...
    <h2 class="text-center text-[white] ">Login Here</h2>
    <form class="flex w-full md:w-[80%] relative m-auto justify-center items-center flex-col" on:submit|preventDefault={handleSubmit}>
     <div class="w-[90%] mb-8 h-[50px]">
         <label class="w-full font-medium text-gray-500 dark:text-gray-400 [&>*]:mt-[0.35rem]" for="admin_id">Email:</label>
       <input class="w-full mt-1 z-[1] bg-[#202140] rounded-md text-[white] h-[40px] border-[1px] border-[gray] pl-3" type="email" id="admin_id" bind:value={admin_id} required />
     </div>
     <div class="w-[90%] mb-8 h-[50px]">
